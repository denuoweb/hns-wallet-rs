...
| Fixed-price Shakedex | implemented source, unavailable | Exact hash/network/time/locking-coin protocol verification, typed cancellation, canonical Denuo envelopes, an encrypted replay/tombstone-safe board, canonical fulfillment/recovery/script-FINALIZE adapters, and encrypted fulfillment/recovery CAS plans now exist. Script-FINALIZE persistence remains unavailable. Supplied Coin/MTP/NameState inputs are not fresh chain authority. Authenticated current/unspent lock and active-chain time/state evidence, HNS lock-key allocation/signing, wallet funding and reservations, fee approval, broadcast/reorg supervision, live relay supervision, trusted approvals, and regtest/restart/reorg product evidence are unavailable; every release gate remains false. |
