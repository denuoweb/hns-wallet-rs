...
| HNS/BTC native settlement | implemented source, unavailable | HNS and Bitcoin HTLC/evidence primitives plus a bounded Kyoto supervisor/pre-broadcast journal exist. The pinned Kyoto header/filter/peer persistence gap, Bitcoin signed-spend supervision, HNS adapter/release gate, end-to-end regtest/restart/reorg evidence, record archival, and resource qualification remain unavailable. |
