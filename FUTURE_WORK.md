...
| Fixed-price Shakedex | implemented source, unavailable | Exact hash/network/time/locking-coin protocol verification, typed cancellation, canonical Denuo envelopes, and an encrypted replay/tombstone-safe board now exist. Authenticated current/unspent lock evidence, typed HNS lock-key allocation/signing, funded fulfillment, two-stage recovery/finalization, live relay supervision, trusted approvals, and regtest/restart/reorg product evidence are unavailable. |
