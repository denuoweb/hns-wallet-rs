...
| FFI/service | deliberate ABI v2 break; canonical length prefix; random host/service sessions; restart and directional sequence binding; 64 KiB request, 256 KiB result, 64 KiB event and 16 KiB typed approval limits; private authority control; fail-closed subprocess | signed released service artifact, private Chromium launcher, generated JNI/Swift bindings, published engine join and compatibility E2E; provider/value/browser capability gates remain false |
